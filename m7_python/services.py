from m7_python.models import Comuna, Inmueble, UserProfile, Region
...
def obtener_propiedades_comunas(filtro): # recibe nombre o descripción
    ...
    return Inmueble.objects.filter(Q(nombre__icontains=filtro) | Q(descripcion__icontains=filtro) | Q(comuna__nombre__icontains=filtro) ).order_by('comuna')  
